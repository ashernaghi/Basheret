...
export class EditKashrutLevelScreen extends React.Component {
  ...
  constructor(props) {
      ...
      this.state= {
        ...
        responseValue: this.props.kashrutObservance+1,
        minObservance: 1,
        maxObservance: 101,
        thumb: 40,
        track: 40,
  ...
  render() {
    ...
    if(this.props.kashrutObservance === undefined){
      var str = "";
      this.props.dispatch(updateUserInfo('info', category[2], str ? str : (50)));
    }
        ...
        <Text style={styles.question}>{this.question}</Text>
          <View style={{flexDirection: 'row', paddingLeft: 40, paddingTop: 40}}>
            <Slider
              ...
              value={this.props.kashrutObservance+1}
