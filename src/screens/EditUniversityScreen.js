...
export class EditUniversityScreen extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      response: this.props.university || '',
    }
  };

  handleSave(){
    this.props.dispatch(updateUserInfo('info', 'university', this.state.response))
    ...
    return (
      <View style={styles.containerStyle}>
        ...
        <View style={styles.questionContainerStyle}>
          <Text style={styles.questionTextStyle}>Edit your University:</Text>
          <UnderlinedInput
